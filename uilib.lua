...
local ArrayField = game:GetObjects("rbxassetid://12893392238")[1]
...
function Hide()
	...
	Debounce = true
	ArrayFieldLibrary:Notify({Title = "Interface Hidden", Content = "The interface has been hidden, you can unhide the interface by tapping ".._G.savingElements["settings"].hidemenu.CurrentKeybind, Duration = 7})
	...
	if Settings.KeySystem then
		...
		if not Passthrough then
			...
			KeyUI.Main.Input.InputBox:GetPropertyChangedSignal('Text'):Connect(function()
				KeyUI.Main.Input.HidenInput.Text = string.rep('â€¢', #KeyUI.Main.Input.InputBox.Text)
			end)
		...
		function Tab:CreateDropdown(DropdownSettings)
			...
			Dropdown.Interact.MouseButton1Click:Connect(function()
				...
				if Dropdown.List.Visible then
					...
					TweenService:Create(Dropdown, TweenInfo.new(0.5, Enum.EasingStyle.Quint), {Size = UDim2.new(0,465, 0, 350)}):Play()
